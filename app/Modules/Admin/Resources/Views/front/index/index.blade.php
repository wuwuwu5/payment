...
<head>
    ...
    <link rel="apple-touch-icon-precomposed"
          href="https://image.uisdc.com/wp-content/uploads/2018/05/uisdc-ico-apple.jpg"/>
    ...
    <link rel="stylesheet" href="wp-content/themes/U/ui/css/slide_new_v=2.3.8.css" type="text/css" media="all"/>
    <link rel="stylesheet" href="wp-content/themes/U/ui/css/fontello_v=2.3.8.css" type="text/css" media="all"/>
    <link rel="stylesheet" href="wp-content/themes/U/ui/css/uisdc_v=2.3.8.css" type="text/css" media="all"/>
    <link rel="stylesheet" href="{{admin_asset('/layui/css/layui.css')}}" media="all">
    <!--[if lt IE 9]>
...
<div class="home-first">
    <div class="container">
        <div class="row">
            <div class="col-3-4">
                <div class="vitara_slide_in" id="spark_slide_homepage_new" data-img-width="970" data-img-height="370"
            ...
            <div class="col-1-4 h-images">
                @foreach(getSlides('home_advertisement', 2) as $slide)
                    <div class="item-tuwen">
                        <a href="{{ empty($slide['redirect']) ?'javaScript::' :$slide['redirect'] }}" target="_blank"
                           class="h-mark">
...
<script src="wp-content/themes/U/ui/js/jquery.js" charset="utf-8"></script>
<script src="wp-content/themes/U/ui/js/touchEvent.js" charset="utf-8"></script>
<script src="wp-content/themes/U/ui/js/qrcode.js" charset="utf-8"></script>
<script src="wp-content/themes/U/ui/js/jquery.qrcode.js" charset="utf-8"></script>
<script src="wp-content/themes/U/ui/js/jquery.slide.js" charset="utf-8"></script>
<script type="text/javascript">
    var uisdc = {};
    uisdc.loginEWM = "https://open.weixin.qq.com/connect/qrconnect?appid=wxb45da3659fa239c0&scope=snsapi_login&redirect_uri=https%3A%2F%2Fwww.uisdc.com%2Fwp-content%2Fthemes%2FU%2Flogin%2Fwxlogin.php%3Fredirect%3Dhttps%3A%2F%2Fwww.uisdc.com%2F&state=0d5a6d0f736e6ba0318d7e6c775df523&login_type=jssdk&self_redirect=false&style=black&href=https://www.uisdc.com/wp-content/themes/U/ui/css/wxlogin.css";</script>
<script src="wp-content/themes/U/ui/js/web_v=2.3.8.js" charset="utf-8"></script>
<script>
    (function () {
...
<!-- Cached page generated by WP-Super-Cache on 2020-05-09 15:14:52 -->
