...
<div class="layui-form-item">
    ...
    <div class="layui-input-block" id="{{ md5(array_get($params,'name','name'))}}">
        ...
        <button class="layui-btn layui-btn-xs layui-btn-info"  id='{{ md5(md5(array_get($params,'name','name'))) }}' data-more="0" data-type="file" data-toggle="fileupload" data-obj="{{ md5(array_get($params,'name','name')) }}">上传文件</button>
    </div>
</div>
