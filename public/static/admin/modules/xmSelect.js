            ...
            return function (e, t) {
                ...
                key: "render", value: function (e) {
                    var t, n = this, o = e.data, r = e.flatData, i = e.prop, l = e.template, a = e.theme, p = e.radio,
                        ...
                        x = (e.remoteMethod, e.delay, e.searchTips), y = e.create, v = e.pageRemote, g = i.name,
            ...
            return function (e, t) {
                ...
                key: "render", value: function (e, t) {
                    var n = this, o = (t.expandedKeys, e.prop), r = e.empty, i = e.sels, l = e.theme, a = e.radio,
                        ...
                        x = o.name, y = o.value, v = o.disabled, g = o.children, w = o.optgroup,
                        k = "hidden" != e.model.icon, C = function (e, t, o) {
                            ...
                            return _("div", {
                                ...
                                class: "xm-option-content",
                                dangerouslySetInnerHTML: {__html: p({data: d, item: e, arr: i, name: e[x], value: e[y]})}
                            }))
                        };
                        ...
                        return {
                            ...
                            filterMethod: function (val, item, index, prop) {
                                ...
                                if (level > 0) {
                                    ...
                                    if (item.name.indexOf(val.toLowerCase()) != -1) {//名称中包含的搜索出来
                                        return true;
                                    }
                                    ...
                                    for (var i = 0; i <= level; i++) {
                                        ...
                                        if (parent !== undefined) {
                                            ...
                                            if (val == name) {//把value相同的搜索出来
                                                return true;
                                            }

                                            if (name.indexOf(val) != -1) {//名称中包含的搜索出来
                                                return true;
                                            }
                                            if (name.indexOf(val.toUpperCase()) != -1) {//名称中包含的搜索出来
                                                return true;
                                            }
                                            if (name.indexOf(val.toLowerCase()) != -1) {//名称中包含的搜索出来
                                                return true;
                                            }
                                            node = parent.__node
                                        }
