layui.extend({}).define(['layer', 'upload'], function (exports) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (successStatus) {
                                ...
                                res.data.policy = res.data[policyFiled];
                                for (var filekey in files) {
                                    that.uploadFile(files, filekey, 1, res.data, button);
                                }
                            } else {
                                policyFailed(res);
                            }
    ...
    Class.prototype.uploadFile = function (filess, filekey, fileCount, data, button) {
        ...
        $.ajax({
            ...
            success: function () {
                var result = {
                    ...
                    ossUrl: data.host + multipleFileKeyArray[successCount],
                    key: multipleFileKeyArray[successCount],
                    elm: button
                };
                //成功无返回
                if (multipleState) {
